...
async def run_client(client_name: str, server_url: str, duration_secs: int):
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a service support voice assistant. Stay focused on service-related help only. If the user asks unrelated general knowledge or off-topic questions, do not answer them. Briefly say you can help only with service-related support and ask for the service issue.",
        },
    ]

    # Note: GoogleLLMService is compatible with OpenAI-style contexts
